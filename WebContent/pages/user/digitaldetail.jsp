...
<div  class="head">
    ...
    <div id="product">
                <div style="float: left;margin-left:100px;margin-top:80px;" class="img_div">
                    <img  style="height:350px;width:350px;" alt="" src="${visitproduct.digitalpic}"/>
                </div>
                <div  style="float: left;margin-top:70px;" class="product_info">
                    ...
                    <div style="margin-bottom: 20px;height:45px;width:500px;border-bottom:2px solid #ccc;" class="book_name">
                        ...
                        <span style="color: gray;font-size:30px;" class="sp2">${visitproduct.digitalname}</span>
                    </div>
                    <div style="width:500px;" class="food_descripe">
                        <span class="sp1">简介:</span>
                        <span class="sp2">${visitproduct.digitaldescribe}</span>
                        <br>
                        <div style="margin-bottom: 20px;" >
                        <span class="sp1">价格:</span>
                        <span class="sp2">${visitproduct.digitalprice}</span>
                    	</div>
                    	<div>
                        <span class="sp1">库存:</span>
                        <span class="sp2">${visitproduct.digitaltotalnum-visitproduct.digitalsoldnum}</span>
                    </div>
                     <br>   <%-- <button bookId="${book.bookid}" class="addToCart">加入购物车</button> --%>
                        <a style="color:blue; " href="<%=basePath%>CartServlet?action=add&itemid=${visitproduct.digitalid}">加入购物车</a>
                    &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                   <a style="color:blue; " class="a1" href="<%=basePath%>DigitalServlet?action=showall">返回数码区</a>
                    </div>
                </div>
