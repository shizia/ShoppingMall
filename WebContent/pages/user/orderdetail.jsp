...
<div id="header">
    ...
    <div >
       ...
       &nbsp;&nbsp;<a href="<%=basePath%>OrderServlet?action=myorder">返回订单页</a>
...
<div id="main">
    ...
    <tr>
			...
			<tbody>
				<c:forEach  items="${orderdetailList}" var="orderitem" varStatus="status">
				<tr >
					<td  height="100">${orderitem.name}</td>
					<td  height="100">${orderitem.price}</td>
					<td  height="100">${orderitem.count}</td>
					<td  height="100">${orderitem.totalPrice}</td>
