...
<div style=" margin-left: 300px;" class="page-container">
	...
	<%-- <div>
		<table class="sellproduct" style="width: 80%;margin-left:150px;margin-top:80px;" border="1" >
			...
			<tbody style="border:none;" >
				<c:forEach  items="${updatebook}" var="book" varStatus="status">
				<tr >
					<td height="180">${book.bookname}</td>
					...
					<td style="border:none;" ><a style="color:black; " href="<%=basePath%>SellServlet?action=update&productid=${book.bookid}">确认修改</a></td>
				</tr>
				</c:forEach>
			</tbody>
		</table>
	...
	<form action="<%=basePath%>UpdateProductServlet" method="post" class="form form-horizontal" id="form-member-add">
		...
		<div class="row cl">
			...
			<input type="text" class="input-text" style="width:270px;" value="${updatebook.bookname}" id="name" name="name">
			<input type="hidden" name="productid" value="${updatebook.bookid}">
			</div>
		</div>
		...
		<div class="row cl">
			...
			<div class="formControls col-xs-8 col-sm-9" style="width:300px;">
			<input type="text" class="input-text" style="width:270px;" value="${updatebook.bookauthor}" id="author" name="author">
			</div>
		</div>
		...
		<div class="row cl">
			...
			<div class="formControls col-xs-8 col-sm-9" style="width:300px;">
			<input type="text"   disabled="disabled" class="input-text" style="width:270px;" value="${updatebook.booktype}" >
			<input type="hidden" id="type" name="type" value="${updatebook.booktype}">
			</div>
		</div>
		...
		<div class="row cl">
			...
			<div class="formControls col-xs-8 col-sm-9" style="width:300px;">
			<input type="text" class="input-text" style="width:270px;" value="${updatebook.bookdescribe}" id="describe" name="describe">
			</div>
		</div>
		...
		<div class="row cl">
			...
			<div class="formControls col-xs-8 col-sm-9" style="width:300px;">
				<input type="number" class="input-text" style="width:270px;" value="${updatebook.bookprice}" id="price" name="price">
			</div>
		</div>
		...
		<div class="row cl">
			...
			<div class="formControls col-xs-8 col-sm-9" style="width:300px;">
				<input type="number" class="input-text" style="width:270px;" value="${updatebook.booktotalnum-updatebook.booksoldnum}" id="leftnum" name="leftnum">
				<%-- <input type="hidden" name="soldnum" value="${updatebook.booksoldnum}"> --%>
			</div>
		</div>
		<div class="row cl">
