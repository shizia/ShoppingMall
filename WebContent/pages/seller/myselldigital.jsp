...
<div class="page-container">
	...
	<form style="margin-top:30px;" action="<%=basePath%>DigitalServlet?action=getDigitalByName" method="post">
	<label class="form-label col-xs-8 col-xs-8">根据数码产品名称搜索：</label>
			<div class="formControls col-xs-8 col-sm-8">
				<input type="text" class="input-text" style="width:270px;" name="getbydigitalname">
	...
	<a style="color:black;margin-left:1250px;" href="<%=basePath%>pages/seller/adddigital.jsp">上架商品</a>
	</div>
	<div>
		<table class="sellproduct" style="width: 80%;margin-left:150px;margin-top:10px;" border="1" >
			...
			<%=request.getAttribute("getByNameError")==null?"":request.getAttribute("getByNameError")%>
				<c:forEach  items="${productList}" var="digital" varStatus="status">
				<tr >
					<td id="productname" height="180">${digital.digitalname}</td>
					...
					<a style="color:black; " href="<%=basePath%>UpdateProductServlet?action=updateproduct&productid=${digital.digitalid}">修改</a>
					&nbsp;&nbsp;<a class="deleteproduct" style="color:black; " href="<%=basePath%>UpdateProductServlet?action=deleteproduct&productid=${digital.digitalid}">下架</a>
					</td> 
