...
<%String updatedigitalid=(String)session.getAttribute("updatedigitalid"); %>
...
<div style=" margin-left: 300px;" class="page-container">
	...
	<%-- <div>
		<table class="sellproduct" style="width: 80%;margin-left:150px;margin-top:80px;" border="1" >
			...
			<tbody style="border:none;" >
				<c:forEach  items="${updatedigital}" var="digital" varStatus="status">
				<tr >
					<td height="180">${digital.digitalname}</td>
					<td height="180">hahaha</td>
					<td>${digital.digitalauthor}</td>
					<td>${digital.digitaldescribe}</td>
					<td style="text-align: center;">${digital.digitalprice}</td>
					<td style="text-align: center;">${digital.digitaltotalnum-digital.digitalsoldnum}</td>
					<td ><img src="<%=basePath%>${digital.digitalpic}" style="height: 150px; width: 150px; "></td>
					<td style="border:none;" ><a style="color:black; " href="<%=basePath%>SellServlet?action=update&productid=${digital.digitalid}">确认修改</a></td>
				</tr>
				</c:forEach>
			</tbody>
		</table>
	...
	<form action="<%=basePath%>UpdateProductServlet" method="post" class="form form-horizontal" id="form-member-add">
		...
		<div class="row cl">
			...
			<input type="text" class="input-text" style="width:270px;" value="${updatedigital.digitalname}" id="name" name="name">
			<input type="hidden" name="productid" value="${updatedigital.digitalid}">
			</div>
		</div>
		...
		<div class="row cl">
			...
			<div class="formControls col-xs-8 col-sm-9" style="width:300px;">
			<input type="text"   disabled="disabled" class="input-text" style="width:270px;" value="${updatedigital.digitaltype}" >
			<input type="hidden" id="type" name="type" value="${updatedigital.digitaltype}">
			</div>
		</div>
		...
		<div class="row cl">
			...
			<div class="formControls col-xs-8 col-sm-9" style="width:300px;">
			<input type="text" class="input-text" style="width:270px;" value="${updatedigital.digitaldescribe}" id="describe" name="describe">
			</div>
		</div>
		...
		<div class="row cl">
			...
			<div class="formControls col-xs-8 col-sm-9" style="width:300px;">
				<input type="number" class="input-text" style="width:270px;" value="${updatedigital.digitalprice}" id="price" name="price">
			</div>
		</div>
		...
		<div class="row cl">
			...
			<div class="formControls col-xs-8 col-sm-9" style="width:300px;">
				<input type="number" class="input-text" style="width:270px;" value="${updatedigital.digitaltotalnum-updatedigital.digitalsoldnum}" id="leftnum" name="leftnum">
				<%-- <input type="hidden" name="soldnum" value="${updatedigital.digitalsoldnum}"> --%>
			</div>
		</div>
		<div class="row cl">
