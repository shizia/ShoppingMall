...
<div style=" margin-left: 300px;" class="page-container">
	...
	<form action="<%=basePath%>AddProductServlet" method="post" class="form form-horizontal" id="form-member-add">
		...
		<div class="row cl">
			...
			<div class="formControls col-xs-8 col-sm-9" style="width:300px;">
			<input type="text" class="input-text" style="width:270px;" id="author" name="author">
			</div>
		</div>
		...
		<div class="row cl">
			...
			<div class="formControls col-xs-8 col-sm-9" style="width:300px;">
				<input type="number" class="input-text" style="width:270px;" placeholder="${updatebook.bookprice}" id="price" name="price">
			</div>
		</div>
