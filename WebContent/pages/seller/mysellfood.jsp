...
<div class="page-container">
	...
	<form style="margin-top:30px;" action="<%=basePath%>FoodServlet?action=getFoodByName" method="post">
	<label class="form-label col-xs-8 col-xs-8">根据食物名称搜索：</label>
			<div class="formControls col-xs-8 col-sm-8">
				<input type="text" class="input-text" style="width:270px;" name="getbyfoodname">
	...
	<a style="color:black;margin-left:1250px;" href="<%=basePath%>pages/seller/addfood.jsp">上架商品</a>
	</div>
	<div>
		<table class="sellproduct" style="width: 80%;margin-left:150px;margin-top:10px;" border="1" >
			...
			<%=request.getAttribute("getByNameError")==null?"":request.getAttribute("getByNameError")%>
				<c:forEach  items="${productList}" var="food" varStatus="status">
				<tr >
					<td id="productname" height="180">${food.foodname}</td>
					...
					<a style="color:black; " href="<%=basePath%>UpdateProductServlet?action=updateproduct&productid=${food.foodid}">修改</a>
					&nbsp;&nbsp;<a class="deleteproduct" style="color:black; " href="<%=basePath%>UpdateProductServlet?action=deleteproduct&productid=${food.foodid}">下架</a>
					</td> 
