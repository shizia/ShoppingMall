...
<div  class="head">
	...
	<div class="htmleaf-container">
		...
		<ul id="main" style=" width: 1200px;">
			...
			<li><a class="a1" href="<%=basePath%>pages/admin/productarea_sell.jsp">商品销售统计</a></li></ul>
...
<div class="page-container">
	<div style="margin-left:150px;;margin-top:30px;"> 
		...
		<form style="margin-top:30px;" action="<%=basePath%>UpdateSellerServlet?action=getSellerByName_action" method="post">
	<label class="form-label col-xs-8 col-xs-8">根据销售员名字搜索：</label>
	...
	<div>
		<table class="sellproduct" style="width: 80%;margin-left:150px;margin-top:10px;" border="1" >
			...
			<thead>
					...
					<th width="180">姓名</th>
					<th width="180">负责的商品区</th>
					<th width="180">负责的商品类型</th>
					<th width="180">查看</th>
				</tr>
			</thead>
			<tbody>
			<%=request.getAttribute("getByNameError")==null?"":request.getAttribute("getByNameError")%>
				...
				<tr >
					...
					<td style="text-align: center;"><a style="color:#3b80c0; " href="<%=basePath%>UpdateSellerServlet?action=showselleraction&sellerid=${seller.identity}">操作记录</a></td>
