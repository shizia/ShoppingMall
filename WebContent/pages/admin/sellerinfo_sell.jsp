...
<div class="page-container">
	<div style="margin-left:150px;;margin-top:30px;"> 
		...
		<form style="margin-top:30px;" action="<%=basePath%>UpdateSellerServlet?action=getSellerByName_sell" method="post">
		...
		<table class="sellproduct" style="width: 80%;margin-left:150px;margin-top:10px;" border="1" >
			...
			<%=request.getAttribute("getByNameError")==null?"":request.getAttribute("getByNameError")%>
				...
				<tr >
					...
					<td style="text-align: center;"><a style="color:#3b80c0; " href="<%=basePath%>SellServlet?action=sellBySellerid&selleridentity=${seller.identity}">销售业绩</a></td>
