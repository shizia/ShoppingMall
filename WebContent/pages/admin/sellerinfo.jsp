...
<div class="page-container">
	...
	<form style="margin-top:30px;" action="<%=basePath%>UpdateSellerServlet?action=getSellerByName" method="post">
	...
	<a style="color:#3b80c0;margin-left:1250px;" href="<%=basePath%>pages/admin/addseller.jsp">增加销售员</a>
	</div>
	<div>
		<table class="sellproduct" style="width: 80%;margin-left:150px;margin-top:10px;" border="1" >
			...
			<%=request.getAttribute("getByNameError")==null?"":request.getAttribute("getByNameError")%>
				...
				<tr >
					...
					<a style="color:#3b80c0; " href="<%=basePath%>UpdateSellerServlet?action=updateseller&sellerid=${seller.identity}">修改</a>
					&nbsp;&nbsp;<a class="deleteseller" style="color:#3b80c0; " href="<%=basePath%>UpdateSellerServlet?action=deleteseller&sellerid=${seller.identity}">删除</a>
					</td> 
