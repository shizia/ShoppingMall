...
<div  class="head">
	...
	<div class="htmleaf-container">
		...
		<ul id="main" style=" width: 1200px;">
			...
			<li style="background-color:black"><a class="a1" href="<%=basePath%>pages/admin/productarea_sell.jsp">商品销售统计</a></li></ul>
...
<div class="page-container">
	...
	<div>
		<table class="sellproduct" style="width: 80%;margin-left:150px;margin-top:10px;" border="1" >
			...
			<tbody>
				<tr >
					<td style="text-align: center;" id="sellerid" height="80">书籍</td>
					<td style="text-align: center;"><a  style="color:#666; " class="a1" href="<%=basePath%>BookServlet?action=showallsell">查看</a></td>	
				</tr>
				<tr >
					<td style="text-align: center;" id="sellerid" height="80">数码</td>
					<td style="text-align: center;"><a  style="color:#666; " class="a1" href="<%=basePath%>DigitalServlet?action=showallsell">查看</a></td>	
				</tr>
				<tr >
					<td style="text-align: center;" id="sellerid" height="80">食品</td>
					<td style="text-align: center;"><a  style="color:#666; " class="a1" href="<%=basePath%>FoodServlet?action=showallsell">查看</a></td>	
				</tr>
			</tbody>
		</table>
	</div>
