...
<div  class="head">
	...
	<div class="htmleaf-container">
		...
		<li><a class="a1" href="<%=basePath%>pages/admin/index.jsp">网站主页</a></li>
			...
			<li style="background-color:black"><a class="a1" href="<%=basePath%>pages/admin/productarea_sell.jsp">商品销售统计</a></li></ul></ul>
		</nav>
	</div>
...
<%-- 	<div style="margin-left:150px;margin-top:30px;"> 
	...
	<label class="form-label col-xs-8 col-xs-8">根据时间搜索：</label>
		...
		<div style="float:left;margin-top: 0px;margin-left: 140px;" class="type-tab">
	 <ul>
     
     <li><a href="<%=basePath%>FoodServlet?action=showallsell">全部</a></li>
     <li><a  href="<%=basePath%>FoodServlet?action=showtypesell&typesell=零食">零食</a></li>
     <li><a  href="<%=basePath%>FoodServlet?action=showtypesell&typesell=水果">水果</a></li>
     <li><a  href="<%=basePath%>FoodServlet?action=showtypesell&typesell=乳品">乳品</a></li>
     <li><a  href="<%=basePath%>FoodServlet?action=showtypesell&typesell=饮料">饮料</a></li>
     <li><a  href="<%=basePath%>FoodServlet?action=showtypesell&typesell=糕点">糕点</a></li>
     
    </ul>
   </div>
	<div>
		<c:if test="${empty sellfoodlist}">
		<p style="margin-left:650px;margin-top:50px;">无销售记录</p>
		</c:if>
		<c:if test="${not empty sellfoodlist}">
		<table class="sellproduct" style="width: 70%;margin-left:150px;margin-top:50px;" border="1" >
			...
			<c:set value="0" var="sum" />  
				<c:forEach  items="${sellfoodlist}" var="sell" varStatus="status">
				<tr >
