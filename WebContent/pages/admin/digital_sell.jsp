...
<%-- 	<div style="margin-left:150px;margin-top:30px;"> 
	...
	<label class="form-label col-xs-8 col-xs-8">根据时间搜索：</label>
     ...
     <li><a href="<%=basePath%>DigitalServlet?action=showallsell">全部</a></li>
     <li><a  href="<%=basePath%>DigitalServlet?action=showtypesell&typesell=手机">手机</a></li>
     <li><a  href="<%=basePath%>DigitalServlet?action=showtypesell&typesell=电脑">电脑</a></li>
     <li><a  href="<%=basePath%>DigitalServlet?action=showtypesell&typesell=相机">相机</a></li>
     
    </ul>
   </div>
	<div>
		<c:if test="${empty selldigitallist}">
		<p style="margin-left:650px;margin-top:50px;">无销售记录</p>
		</c:if>
		<c:if test="${not empty selldigitallist}">
		<table class="sellproduct" style="width: 70%;margin-left:150px;margin-top:50px;" border="1" >
			...
			<c:set value="0" var="sum" />  
				<c:forEach  items="${selldigitallist}" var="sell" varStatus="status">
				<tr >
